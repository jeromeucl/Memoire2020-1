...
column.notnull().astype(int)
tbl2 = tbl.apply(lambda column: print(column.notnull().astype(int)) if ('_frequency' in column.name) else column, axis=0)
