...
scaled = features_selection(worktbl_db, tbl_db['1001_frequency'], 10)
...
k_range = list(range(1,20)) + [30,50,100]
...
def modeltest(model,scaleds,label,parameters):
    ...
    bcr=balanced_accuracy_score(Y_test, predi)
    print(bcr)

    return bcr

from sklearn.linear_model import LogisticRegression
result = modeltest(LogisticRegression(),scaled,tbl_db['1001_frequency'],dict(random_state=[0]))