...
#This information might have some interest
...
exercise_scheme_of_the_day_before.columns = exercise_scheme_of_the_day_before.columns.str.replace('actual', 'actual_frequency_yesterday')
exercise_scheme_of_the_day_before.columns = exercise_scheme_of_the_day_before.columns.str.replace('intensity', 'intensity_yesterday')
...
worktbl = worktbl.drop(['is_basic_strength', 'is_functional_strength', 'is_mobility', 'is_symp_reduction', 'calories'], axis=1)
