...
exercise_scheme_of_the_day_before.columns = map(str.upper, exercise_scheme_of_the_day_before.columns)
exercise_scheme_of_the_day_before.rename(columns={'PATIENT_ID': 'patient_id', 'DAY': 'day'}, inplace=True)
